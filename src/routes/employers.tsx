        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <section className="grid gap-6 md:grid-cols-3">
            <div className="rounded-3xl border border-border bg-background p-6">
              <h2 className="font-display text-xl font-semibold">Reach verified candidates</h2>
              <p className="mt-3 text-sm text-muted-foreground">
                Connect with applicants who are actively searching, experienced, and ready to grow
                their careers.
              </p>
            </div>
            <div className="rounded-3xl border border-border bg-background p-6">
              <h2 className="font-display text-xl font-semibold">Post jobs in minutes</h2>
              <p className="mt-3 text-sm text-muted-foreground">
                Create targeted listings for jobs in Dar es Salaam, Arusha, Mwanza, and beyond.
              </p>
            </div>
            <div className="rounded-3xl border border-border bg-background p-6">
              <h2 className="font-display text-xl font-semibold">Track applications</h2>
              <p className="mt-3 text-sm text-muted-foreground">
                Review candidates, save favorites, and stay organized from a central dashboard.
              </p>
            </div>
          </section>
          ...
          <section className="rounded-3xl border border-border bg-card p-10">
            ...
            <ul className="mt-6 space-y-4 text-sm text-foreground/80">
              ...
              <li className="space-y-2">
                <strong className="block font-semibold">Verified employer visibility</strong>
                <span className="block text-muted-foreground">
                  Build trust with candidates through employer profiles and verified listings.
                </span>
              </li>
              <li className="space-y-2">
